    ...
    <div class="block">
      <div class="banner">
        ...
        <div class="banner-content">
          ...
          <a href="view/connexion.php" class="btn btn-primary btn-lg" role="button">S'abonner</a>
        </div>
      </div>
    </div>
        ...
        <h3 class="title">voitures volées en 2019 en France
      </h3>

      <div class="pb_text">
        <h3>
          <span>
            "1 voiture volée toutes les "
