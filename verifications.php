...
<!--- Formulairee pour connaitre la voiture du client --->
       <form action="offres_traitement.php" method="post">
         <div class="form-group">
           <a>Nous avons besoin de votre numéro de téléphone pour l'installation.
              L'installateur Takecare vous appellera à la suite de votre abonnement pour fixer un rdv d'installation de l'antivol automobile</a>
